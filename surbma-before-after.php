...
function surbma_before_after_scripts( ) {
	wp_enqueue_script( 'surbma-before-after-event-move', plugins_url( '', __FILE__ ) . '/js/jquery.event.move.js', array('jquery'), '', true );
	wp_enqueue_script( 'surbma-before-after-twentytwenty', plugins_url( '', __FILE__ ) . '/js/jquery.twentytwenty.js', array('jquery'), '', true );

	wp_enqueue_style( 'surbma-before-after-twentytwenty-style', plugins_url( '', __FILE__ ) . '/css/twentytwenty.css' );
}
...
add_shortcode( 'before-after', 'surbma_before_after_shortcode' );
